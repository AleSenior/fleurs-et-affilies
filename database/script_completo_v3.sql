...
--CAMBIAR
('f11111', 'blanco y rojo', 'Unión, amor eterno. Las flores rojas y blancas son una combinación llamativa y que encarnan todos los sentimientos y emociones de un verdadero vínculo.'),
...
--CAMBIAR
('f22222', 'amarillo y rojo', 'Enamoramiento, el inicio de un nuevo romance. El amarillo simboliza su amistad actual y el rojo indica que deseas avanzar hacia una nueva relación.'),
...
INSERT INTO Contrato_CAB (numero, fecha, clasificacion, prod_total_pcnt, cancelado, id_casa_subastadora, id_productor, numero_contrato_original) VALUES
(1, '2024-01-15', 'CA', '55', NULL, 1, 1, NULL),
(2, '2024-03-22', 'CB', '30', NULL, 2, 2, NULL),
(3, '2024-05-10', 'CC', '15', NULL, 3, 3, NULL),
(4, '2024-06-18', 'KA', '100', NULL, 1, 1, NULL),
(5, '2024-08-05', 'CG', '45', NULL, 2, 2, NULL),
(6, '2024-09-12', 'CB', '25', NULL, 3, 3, NULL);
